...
public interface BoardRepository extends JpaRepository<BoardEntity, Long> {
    ...
    @Query("SELECT b FROM BoardEntity b WHERE b.code = :boardCode AND b.project.code = :projectCode")
    Optional<BoardEntity> findByCodeAndProjectCode(@Param("boardCode") String boardCode, @Param("projectCode") String projectCode);
